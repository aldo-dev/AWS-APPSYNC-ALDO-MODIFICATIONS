Pod::Spec.new do |s|
  s.name         = 'AWSAppSyncALDO'
  s.version      = '2.6.16'
  s.author       = 'AWS'
  s.homepage     = 'http://aws.amazon.com/mobile/sdk'
  s.license      = { :type => 'Amazon Software License', :file => 'LICENSE' }
  s.summary      = "iOS client to access AWSAppSync backend. ALDO modifications"
  s.source       = { :git => 'https://github.com/aldo-dev/aws-appsync-aldo.git',
                     :tag => s.version}
  s.requires_arc = true
  ...
  #   'AWSAppSyncClient/ALDOAppSync/*.swift'
